 ...
 */
public class DriverMeFragment extends Fragment {
    ...
    private ImageButton mBtSwitchRole = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_driver_me, container, false);
        ...
        mMyCar = (LinearLayout)v.findViewById(R.id.btMyCar);
    ...
    private void initEventHandler(){
        ...
        mMyAD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!UserState.getInstance().isAuthed()){
                    ...
                    Intent i = new Intent(getActivity(), DriverMyAdsActivity.class);
                    startActivity(i);
                }
            }
        });
        mMyCar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), DriverMyCarsActivity.class);
                startActivity(i);
            }
        });
        ...
        switch(requestCode){
            case ACTIVITY_REQ_LOGIN:
            {
                if(resultCode == getActivity().RESULT_OK) {
                    logger.logDebug(TAG, "login succeed?" + UserState.getInstance().isAuthed());
                    onLoginSucceed();
